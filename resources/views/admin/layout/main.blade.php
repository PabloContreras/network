...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="public/img/dashboard/sidebar-1.jpg">
      <!--
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item   ">
            <a class="nav-link" href="{{ url('/admin/homedash') }}">
...
<footer class="footer">
        <div class="container-fluid">
          <div class="copyright float-right">
            ...
            </script>, Hecho con <i class=" material-icons red600" > favorite</i> y <i class="material-icons">warning</i> by
